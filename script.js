...
function salvarPerguntasLocalStorage(){
  let perguntas = [
    ...
    {
      id: "5",
      texto: "Qual e o elemento quimico com o simbolo 'O'?",
...
function statica(){
  tela.setAttribute("src", "https://cdn.glitch.global/03fce93d-4bd4-4e69-b719-a203a5ad36a4/tv-estatica.png?v=1731676551515");
...
function verificarResposta(opcaoEscolhida) {
  ...
  for(let pergunta of perguntas){
    if(opcaoEscolhida === pergunta.correta){
      ...
      perguntaTexto.setAttribute("value", "Certa Resposta!");
  ...
  perguntaTexto.setAttribute("value", "Tu Errou!");
